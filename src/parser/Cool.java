/* Generated By:JavaCC: Do not edit this line. Cool.java */
package parser;
import java.io.*;
public class Cool implements CoolConstants {
        ...
        if(args[i].equals("-")) {
          ...
          System.out.printls("Reading from file " + filename + ". . .");
          try {
        ...
        // verifica se houve erro léxico token_sourse
